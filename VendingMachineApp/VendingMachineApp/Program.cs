...
// candy, chip, drink, insufficientfundsexception, item, outofstockexception, vendingmachine.cs
/*
            ...
            try
            {
                switch (command)
                {
                    case "insert":
                        ...
                        statusMessage = $"Inserted ${amount}. Balance: ${vm.CurrentBalance}";
                        break;

                    case "select":
                        vm.PurchaseItem(argument);
                        statusMessage = $"Success, Balance: ${vm.CurrentBalance}";
                        Console.ReadLine();
                        break;

                    case "refund":
                        vm.Refund();
                        statusMessage = $"Refund : , Balance: ${vm.CurrentBalance}";
